    ...
    <div class="my-container">
        <div class="glavni-in">
            <div class="sec-glavni">
                ...
                <p class="txt-18 ab2">
                    Оказываем широкий спектр услуг в рекламе и производстве рекламных носителей. Сотрудничаем с
                    ведущими поставщиками оборудования. Имеем свои рекламные конструкции и LED экраны по региону
                </p>
            ...
            <a href="work.html" class="glavni-blog ab4">
                ...
                <div class="sec-r">
                    <p class="txt-18">Разработка дизайна и фирменный стиль</p>
